<template>
  <div class="section" id="select">
    <h1 class="md-display-3 s1-U__mg--bt16">Select</h1>

    <div class="s1-U__mg--bt16">
      <a class="s1-U__text-ellipsis s1-U__full-width" target="_blank" href="https://vuematerial.io/components/select">vuematerial.io/select</a>
    </div>

<template>
  <div class="section" id="fields">
    ...
    <div>
      <h2 class="display-2">2. Errors and Messages</h2>
    ...
    <div>
      <h2 class="display-2">3. Character count</h2>
    ...
    <div>
      <h2 class="display-2">4. Inline actions</h2>
    ...
    <div>
      <h2 class="display-2">5. Prefixes & suffixes</h2>
